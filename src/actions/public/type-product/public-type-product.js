...
// export async function getTypeProduct(filter = {}, page = 1, perPage = 10) {
//   try {
//     let data, total;
...
// export async function createTypeProduct(data) {
//   try {
...
// export async function updateTypeProduct(data) {
//   try {
...
// export async function deleteTypeProduct(id) {
//   try {
//     await db("type_products").where({ id }).delete();
//     return { success: true };
//   } catch (error) {
...
//   try {
//     const data = await db("type_products").where("id", id).first();
...
export async function getAllPublicTypeProduct() {
  try {
