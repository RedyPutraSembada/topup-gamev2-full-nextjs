...
import { useGetNews } from "@/data/admin/news/product-datas";
import { deleteNews } from "@/actions/admin/news/news";
import { DataTableNews } from "./data-table-news";

export function DataNewsList({ categories }) {
  ...
  const { data, error, isLoading, refetch } = useGetNews(
    {
      ...filter,
  ...
  const handleEdit = (values) => {
    router.push("/admin/news/" + values + "/edit");
  };
